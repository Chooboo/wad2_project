...
def api_question(request):
    raw_questions = QuizPage.object.filter
    question = []

    for raw_questions in raw_questions:
        question = {}
        question['question'] = raw_questions.question
        question['answer'] = raw_questions.answer
        options = []
        if raw_questions.option_one !='':
            options.append(raw_questions.option_one)
        if raw_questions.option_two !='':
            options.append(raw_questions.option_two)
        if raw_questions.option_three !='':
            options.append(raw_questions.option_three)
        if raw_questions.option_four !='':
            options.append(raw_questions.option_four)
